...
import io.openvidu.embedded.client.auth.Authentication;

@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.11.0")
public class ApiClient extends JavaTimeFormatter {
  private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  private Map<String, String> defaultCookieMap = new HashMap<String, String>();
  private String basePath = "http://localhost:6080/embedded/api/v1";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://localhost:6080/embedded/api/v1",
      "Development server",
  ...
  public ApiClient(CloseableHttpClient httpClient) {
    ...
    setUserAgent("OpenViduEmbeddedJavaClient");
