...
export const RTMP_EXPORTER_URL = process.env.RTMP_EXPORTER_URL || 'http://localhost:5100';
export const RTMP_EXPORTER_CREDENTIALS = process.env.RTMP_EXPORTER_CREDENTIALS || 'admin:password';
...
export const CALL_STREAMING = process.env.CALL_STREAMING || 'ENABLED';
